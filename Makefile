...
DOC_TAG      ?= development
RELEASE      ?= latest
PUBLISHDIR    = /tmp/intelligent_resources
...
publish:
	git clone --reference . https://github.com/IntelligentRoboticsLabs/Intelligent_Resources.github.io.git $(PUBLISHDIR)
	cd $(PUBLISHDIR) && \
	git checkout gh-pages && \
	git config user.email "jc.manzanares.serrano@gmail.com" && \
